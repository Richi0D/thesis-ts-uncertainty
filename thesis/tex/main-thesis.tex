...
\title{Uncertainty Quantification for Recurrent Time Series Foundation Models}
...
\supervisor{\prefix{} Marco~Pichler \suffix{MSc}}

%% Command \assistantsupervisor{name}: sets the name of the assistant supervisor(s)
\assistantsupervisor{Marco~Pichler \suffix{MSc}}
